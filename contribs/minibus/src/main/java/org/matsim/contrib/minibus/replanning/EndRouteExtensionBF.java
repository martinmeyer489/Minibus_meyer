...
public final class EndRouteExtensionBF extends AbstractPStrategyModule {
    ...
    protected Set<Id<TransitStopFacility>> getStopsUsed(Collection<TransitRoute> routes) {
    ...
    protected Geometry createBuffer(List<Geometry> lineStrings, double bufferSize, boolean excludeTermini) {
